...
type ConstantsProductListType string

// List of constants.ProductListType
const (
	CODE ConstantsProductListType = "product-code"
	NAME ConstantsProductListType = "product-name"
	TYPE_CODE ConstantsProductListType = "product-type-code"
)
