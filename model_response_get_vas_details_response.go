...
type ResponseGetVasDetailsResponse struct {
	VasCode string `json:"vas_code,omitempty"`
	VasId int32 `json:"vas_id,omitempty"`
	VasName string `json:"vas_name,omitempty"`
	VasPrice float32 `json:"vas_price,omitempty"`
}
