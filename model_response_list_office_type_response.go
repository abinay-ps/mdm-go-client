...
type ResponseListOfficeTypeResponse struct {
	AdminFlag bool `json:"admin_flag,omitempty"`
	ChildOfficeTypeCode string `json:"child_office_type_code,omitempty"`
	ChildOfficeTypeName string `json:"child_office_type_name,omitempty"`
	...
	ParentOfficeTypeName string `json:"parent_office_type_name,omitempty"`
}
