...
type ResponseUpdateMergeOfficesResponse struct {
	SourceOffice *ResponseUpdateOfficeDetails `json:"source_office,omitempty"`
	TargetOffice *ResponseUpdateOfficeDetails `json:"target_office,omitempty"`
}
