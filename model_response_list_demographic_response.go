...
type ResponseListDemographicResponse struct {
	DistrictNames []string `json:"district_names,omitempty"`
	StateNames []string `json:"state_names,omitempty"`
	TalukNames []string `json:"taluk_names,omitempty"`
	VillageNames []string `json:"village_names,omitempty"`
}
