...
type ResponseUpdateProductDetailsResponse struct {
	...
	// Fixed spelling
	DeliveryToAddressInPersonRequired bool `json:"delivery_to_address_in_person_required,omitempty"`
	...
	// Fixed spelling
	StampCategoryDescription string `json:"stamp_category_description,omitempty"`
