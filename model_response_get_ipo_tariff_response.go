...
type ResponseGetIpoTariffResponse struct {
	IpoCommission float32 `json:"ipo_commission,omitempty"`
	IpoPrice float32 `json:"ipo_price,omitempty"`
	IpoTotalPrice float32 `json:"ipo_total_price,omitempty"`
