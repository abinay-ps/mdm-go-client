...
type HandlerUpdateMergeOfficesRequest struct {
	SourceOfficeDetails *HandlerUpdateOfficeDetails `json:"source_office_details"`
	TargetOfficeDetails *HandlerUpdateOfficeDetails `json:"target_office_details"`
}
